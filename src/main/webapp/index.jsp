		...
		<div id="main">
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img class="d-block w-100"
							src="images/slider-image-1-1920x700.jpg" alt="First slide" />
					</div>
					<div class="carousel-item">
						<img class="d-block w-100"
							src="images/slider-image-2-1920x700.jpg" alt="Second slide" />
					</div>
					<div class="carousel-item">
						<img class="d-block w-100"
							src="images/slider-image-3-1920x700.jpg" alt="Third slide" />
					</div>
				</div>
			...
			<div class="inner">
				...
				<header id="inner">
					...
					<blockquote>
						<p>
							<i>"Books are the quietest and most constant of friends; they
				...
				<header id="inner">
					<blockquote>
						<p>
							<i>"A person who won’t read has no advantage over one who
								can’t read."</i>
						</p>
				...
				<div class="container-homes">
					<c:forEach items="${homes}" var="idx">
					<a href="HomeStayController?id=${idx.getId()}">
						<div class="container">
							...
							<%--	<div class="about">
								<div class="tilte-price">Rất tốt</div>
								<div class="price">9.2</div>
							</div>  --%>
						</div>
					</c:forEach>
				...
				<div class="row">
					<div class="col-sm-4 text-center">
						...
						<h2 class="m-n">
							<a href="#">LEARN HOW TO HEAL YOURSELF</a>
						</h2>
					...
					<div class="col-sm-4 text-center">
						...
						<h2 class="m-n">
							<a href="#">WHAT I READ IN THE FIRST 4 MONTHS OF THE YEAR</a>
						</h2>
					...
					<div class="col-sm-4 text-center">
						...
						<h2 class="m-n">
							<a href="#">\Novel Recommended/: Classroom of the Elite</a>
						</h2>
				...
				<section>
					...
					<ul class="alt">
						<li><span class="fa fa-github"></span> <a
							href="https://github.com/anhnndndn">Nguyen Duy Anh</a></li>
						<li><span class="fa fa-map-pin"></span> <a
							href="https://goo.gl/maps/ojwCjTqRteiA4B9U7"> BE-119, FPT
								University</a></li>
					</ul>
				</section>
