...
<nav id="menu">
    ...
    <ul>
        ...
        <li><a href="Login?origin=./about.jsp"><i class="fa fa-sign-in"></i>Login</a></li>
            <% } else{ %>
            ...
            <footer id="footer">
                <div class="inner">
                    <section>
                        <h2>Contact Info</h2>
                        <ul class="alt">
                            <li><span class="fa fa-github"></span> <a href="https://github.com/anhnndndn">Nguyen Duy Anh</a></li>
                            <li><span class="fa fa-map-pin"></span> <a href="https://goo.gl/maps/ojwCjTqRteiA4B9U7"> BE-119, FPT University</a></li>
                        </ul>
                    </section>
                    <ul class="copyright">
                        <li> HMT </li>
